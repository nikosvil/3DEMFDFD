function plot_E_Sec(nx,ny,nz,hx,hy,hz,EX,EY)
...
% savefig(h,(sprintf('%sx%sx%s_imag(EY-Sec).fig',int2str(nx),int2str(ny),int2str(nz))));
%saveas(h,(sprintf('%sx%sx%s_imag(EY-Sec).png',int2str(nx),int2str(ny),int2str(nz))));
