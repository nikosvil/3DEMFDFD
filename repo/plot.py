...
'''******************************************'''
file1=open('../../../../EbackFiles_Halfspace/%s/E_Prim_%s_Sec_%s_f_%s/ETX%s.txt' %(coor,sPrim,sSec,freq,nx),'r')
ETX=file1.read()
file1.close()
...
file1=open('../../../../EbackFiles_Halfspace/%s/E_Prim_%s_Sec_%s_f_%s/ETX%s.txt' %(coor,sPrim,sSec,freq,nx),'w')
file1.write(ETX)
file1.close()

file1=open('../../../../EbackFiles_Halfspace/%s/E_Prim_%s_Sec_%s_f_%s/ETY%s.txt' %(coor,sPrim,sSec,freq,nx),'r')
ETY=file1.read()
file1.close()
...
file1=open('../../../../EbackFiles_Halfspace/%s/E_Prim_%s_Sec_%s_f_%s/ETY%s.txt' %(coor,sPrim,sSec,freq,nx),'w')
file1.write(ETY)
file1.close()
'''******************************************'''
dataEtotalX=np.loadtxt('EtotalX.txt' ,dtype=complex)
dataEtotalY=np.loadtxt('EtotalY.txt' ,dtype=complex)
dataETX=np.loadtxt('../../../../EbackFiles_Halfspace/%s/E_Prim_%s_Sec_%s_f_%s/ETX%s.txt' %(coor,sPrim,sSec,freq,nx),dtype=complex)
dataETY=np.loadtxt('../../../../EbackFiles_Halfspace/%s/E_Prim_%s_Sec_%s_f_%s/ETY%s.txt' %(coor,sPrim,sSec,freq,nx),dtype=complex)
