...
mkdir -p $dirstr
mkdir -p $dirstr/f2m
cp ./repo/main.m $dirstr/f2m 
cp ./repo/comp_dev_rel_err.m $dirstr/f2m 
cp ./repo/node_E.m $dirstr/f2m
cp ./repo/node_H.m $dirstr/f2m
cp ./repo/case_data_validate_error.m $dirstr/f2m
cp ./repo/case_data_E.m $dirstr/f2m
cp ./repo/plot_H.m $dirstr/f2m
cp ./repo/plot_E_Total.m $dirstr/f2m
cp ./repo/plot_err_all_nodes.m $dirstr/f2m
cd repo
...
#mv ./temp/ETX.txt $dirstr/f2m 
#mv ./temp/ETY.txt $dirstr/f2m
